...
namespace DHPlaySDK
{
    ...
    public sealed class DHPlay
    {
       ...
       // private static bool initialized = false;
        ...
        private static OPERATION_INFO DHThrowLastError(int nPort)
        {
        ...
        /// <returns>true:成功;false:失败</returns>
        public static bool DHSetDisplayRegion(int nPort, UInt32 nRegionNum, IntPtr pSrcRect, IntPtr hDestWnd, bool bEnable)
        {
            bool returnValue = false;
        ...
        /// <returns>true:成功;false:失败</returns>
        public static bool DHRefreshPlayEx(int nPort, UInt32 nRegionNum)
        {
            bool returnValue = false;
        ...
        /// <returns>true:成功;false:失败</returns>
        public static bool DHStartDataRecord(int nPort, string sFileName, int idataType)
        {
            bool returnValue = false;
        ...
        /// <param name="nPort">播放器通道号</param>
        /// <returns>true:成功;false:失败</returns>
        public static bool DHStopDataRecord(int nPort)
        {
            bool returnValue = false;
        ...
        /// <returns>true:成功;false:失败</returns>
        public static bool DHSetDisplayCallBack(int nPort, DisplayCBFun dCBFun, int nUser)
        {
            bool returnValue = false;
        ...
        /// <param name="dCBFun">DisplayCBFun的回调函数</param>
        /// <returns>true:成功;false:失败</returns>
        public static bool DHSetDisplayCallBack(int nPort, DisplayCBFun dCBFun)
        {
        ...
        /// <returns>true:成功;false:失败</returns>
        public static bool DHSetAudioCallBack(int nPort, FunAudio funAudio, int nUser)
        {
            bool returnValue = false;
        ...
        /// </returns>
        public static UInt32 DHGetSdkVersion()
        {
        ...
        public static string DHGetSdkVersion(string verFormatStyle)
        {
        ...
        public static string DHConvertToTime(uint uintValue, decimal rate, string timeStyle)
        {
        ...
        #region << 音频控制 >>
        public const string SDK_DHPLAYER = @".\Driver\dahuaPlayer\dhplay.dll";
        /// <summary>
        /// 打开声音
