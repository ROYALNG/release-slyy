...
namespace GHIBMS.NHikPlayer
{
    ...
    public sealed class HikPlayer
    {
        ...
        public static readonly int PLAYER_SLIDER_MAX = 100;
        ...
        #endregion
        public const string SDK_HIKPLAYER = @".\Driver\hikvision\PlayCtrl.dll";
        #region HikPlayer
        /// <summary>
        ...
        [DllImport(SDK_HIKPLAYER)]
        public static extern bool PlayM4_InputData(int nPort, IntPtr pBuf, ushort nSize);
