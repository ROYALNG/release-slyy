...
namespace NHikPlayer
{
	...
	public sealed class HikPlayer
	{
		...
		/// 注意：当Hik_PlayM4_InputData()返回FALSE时，用户要等一下重新输入。
		/// </summary>
		...
		/// no error
		/// </summary>
		public static readonly int HIK_PLAYM4_NOERROR = 0;
		/// <summary>
		/// 输入参数非法
		/// input parameter is invalid;
		/// </summary>
		public static readonly int HIK_PLAYM4_PARA_OVER = 1;
		/// <summary>
		/// 调用顺序不对
		/// The order of the function to be called is error.
		/// </summary>
		public static readonly int HIK_PLAYM4_ORDER_ERROR = 2;
		/// <summary>
		/// 多媒体时钟设置失败
		/// Create multimedia clock failed;
		/// </summary>
		public static readonly int HIK_PLAYM4_TIMER_ERROR = 3;
		/// <summary>
		/// 视频解码失败
		/// Decode video data failed.
		/// </summary>
		public static readonly int HIK_PLAYM4_DEC_VIDEO_ERROR = 4;
		/// <summary>
		/// 音频解码失败
		/// Decode audio data failed.
		/// </summary>
		public static readonly int HIK_PLAYM4_DEC_AUDIO_ERROR = 5;
		/// <summary>
		/// 分配内存失败
		/// Allocate memory failed.
		/// </summary>
		public static readonly int HIK_PLAYM4_ALLOC_MEMORY_ERROR = 6;
		/// <summary>
		/// 文件操作失败
		/// Open the file failed.
		/// </summary>
		public static readonly int HIK_PLAYM4_OPEN_FILE_ERROR = 7;
		/// <summary>
		/// 创建线程事件等失败
		/// Create thread or event failed.
		/// </summary>
		public static readonly int HIK_PLAYM4_CREATE_OBJ_ERROR = 8;
		/// <summary>
		/// 创建DirectDraw失败
		/// Create DirectDraw object failed.
		/// </summary>
		public static readonly int HIK_PLAYM4_CREATE_DDRAW_ERROR = 9;
		/// <summary>
		/// 创建后端缓存失败
		/// Failed when creating off-screen surface.
		/// </summary>
		public static readonly int HIK_PLAYM4_CREATE_OFFSCREEN_ERROR = 10;
		/// <summary>
		/// 缓冲区满，输入流失败
		/// Buffer is overflow.
		/// </summary>
		public static readonly int HIK_PLAYM4_BUF_OVER = 11;
		/// <summary>
		/// 创建音频设备失败
		/// Failed when creating audio device.
		/// </summary>
		public static readonly int HIK_PLAYM4_CREATE_SOUND_ERROR = 12;
		/// <summary>
		/// 设置音量失败
		/// Set volume failed.
		/// </summary>
		public static readonly int HIK_PLAYM4_SET_VOLUME_ERROR = 13;
		/// <summary>
		/// 只能在播放文件时才能使用此接口
		/// The function only support play file.
		/// </summary>
		public static readonly int HIK_PLAYM4_SUPPORT_FILE_ONLY = 14;
		/// <summary>
		/// 只能在播放流时才能使用此接口
		/// The function only support play stream.
		/// </summary>
		public static readonly int HIK_PLAYM4_SUPPORT_STREAM_ONLY = 15;
		/// <summary>
		/// 系统不支持，解码器只能工作在Pentium 3以上
		/// System not support.
		/// </summary>
		public static readonly int HIK_PLAYM4_SYS_NOT_SUPPORT = 16;
		/// <summary>
		/// 没有文件头
		/// No file header.
		/// </summary>
		public static readonly int HIK_PLAYM4_FILEHEADER_UNKNOWN = 17;
		/// <summary>
		/// 解码器和编码器版本不对应
		/// The version of decoder and encoder is not adapted.  
		/// </summary>
		public static readonly int HIK_PLAYM4_VERSION_INCORRECT = 18;
		/// <summary>
		/// 初始化解码器失败
		...
		/// </summary>
		public static readonly int HIK_PLAYM4_CHECK_FILE_ERROR = 20;
		/// <summary>
		/// 初始化多媒体时钟失败
		/// Initialize multimedia clock failed.
		/// </summary>
		public static readonly int HIK_PLAYM4_INIT_TIMER_ERROR = 21;
		/// <summary>
		/// 位拷贝失败
		/// Blt failed.
		/// </summary>
		public static readonly int HIK_PLAYM4_BLT_ERROR = 22;
		/// <summary>
		/// 显示Overlay失败
		/// Update failed.
		/// </summary>
		public static readonly int HIK_PLAYM4_UPDATE_ERROR = 23;
		/// <summary>
		/// 打开文件错误
		/// Open file error, stream type is multi.
		/// </summary>
		public static readonly int HIK_PLAYM4_OPEN_FILE_ERROR_MULTI = 24;
		/// <summary>
		/// 打开文件错误
		/// Open file error, stream type is video.
		/// </summary>
		public static readonly int HIK_PLAYM4_OPEN_FILE_ERROR_VIDEO = 25;
		/// <summary>
		/// JPEG格式压缩错误
		/// JPEG compress error.
		/// </summary>
		public static readonly int HIK_PLAYM4_JPEG_COMPRESS_ERROR = 26;
		/// <summary>
		/// 不支持此文件的版本
		/// Don't support the version of this file.
		/// </summary>
		public static readonly int HIK_PLAYM4_EXTRACT_NOT_SUPPORT = 27;
		/// <summary>
		/// 提取视频数据失败
		/// Extract video data failed.
		/// </summary>
		public static readonly int HIK_PLAYM4_EXTRACT_DATA_ERROR = 28;
		...
		/// 快速播放，每次调用将使当前播放速度加快一倍，最多调用4次；要恢复正常播放调用Hik_PlayM4_Play()，
		/// 从当前位置开始正常播放
		/// </summary>
		/// <param name="nPort"></param>
		/// <returns></returns>
		...
		/// 设置回调函数，替换播放器中的显示部分，有用户自己控制显示，该函数在Hik_PlayM4_Play()之前调用，
		/// 在Hik_PlayM4_Stop()时自动失效，下次调用Hik_PlayM4_Play()之前需要重新设置。
		...
		[DllImport("HikPlayM4.dll")]
		public static extern int Hik_PlayM4_GetFileTotalFrames(int nPort);
		...
		/// <returns></returns>
		[DllImport("HikPlayM4.dll")]
		public static extern bool Hik_PlayM4_SetPlayedTimeEx(int nPort, int nTime);

		/// <summary>
		/// 31、DWORD Hik_PlayM4_GetCurrentFrameNum(LONG nPort); 
		/// 得到当前播放的帧序号。而Hik_PlayM4_GetPlayedFrames()是总共解码的帧数。如果文件播放位置
		/// 不被改变，那么这两个函数的返回值应该非常接近，除非码流丢失数据。 
		/// </summary>
		/// <param name="nPort"></param>
		/// <returns></returns>
		[DllImport("HikPlayM4.dll")]
		public static extern int Hik_PlayM4_GetCurrentFrameNum(int nPort);
		...
		/// <returns></returns>
		[DllImport("HikPlayM4.dll")]
		public static extern int Hik_PlayM4_GetLastError(int nPort);
		...
		/// 以共享方式关闭声音。Hik_Playm4_PlaySound()和Hik_PlayM4_StopSound()是以独占方式播放声音的。
		...
		/// <returns>颜色值</returns>
		[DllImport("HikPlayM4.dll")]
        public static extern uint Hik_PlayM4_GetColorKey(int nPort);
		...
		/// <returns></returns>
		[DllImport("HikPlayM4.dll")]
        public static extern ushort Hik_PlayM4_GetVolume(int nPort);
		...
		/// <returns></returns>
		[DllImport("HikPlayM4.dll")]
		public static extern bool Hik_PlayM4_ThrowBFrameNum(int nPort, int nNum);
		...
		/// </returns>
		[DllImport("HikPlayM4.dll")]
		public static extern int Hik_PlayM4_GetDDrawDeviceTotalNums();
		...
		/// <returns></returns>
		[DllImport("HikPlayM4.dll")]
		public static extern bool Hik_PlayM4_SetDDrawDevice(int nPort, int nDeviceNum);
		...
		/// <returns></returns>
		[DllImport("HikPlayM4.dll")]
		public static extern bool Hik_PlayM4_GetDDrawDeviceInfo(int nDeviceNum, string lpDriverDescription, ushort nDespLen, string lpDriverName, ushort nNameLen, IntPtr hhMonitor);
		...
		/// <returns></returns>
		[DllImport("HikPlayM4.dll")]
		public static extern int Hik_PlayM4_GetCapsEx(int nDDrawDeviceNum);
		...
		/// 表示对主要显示窗口(Hik_PlayM4_Play中设置的窗口)进行设置，将忽略hDestWnd和bEnable的设置。</param>
		...
		/// 设置文件索引。如果已经有了文件索引信息，可以不再调用生成索引的回调函数(53.Hik_PlayM4_SetFileRefCallBack)，
		...
		/// <returns></returns>
		[DllImport("HikPlayM4.dll")]
		public static extern bool Hik_PlayM4_SetTimerType(int nPort, int nTimerType, ushort nReserved);
		...
		/// 调整WAVE波形，可以改变声音的大小。它和Hik_PlayM4_SetVolume()的不同在于，它是调整声音数据，
		...
		[DllImport("HikPlayM4.dll")]
        public static extern bool Hik_PlayM4_GetBMP(int nPort, byte[] pBitmap, int nBufSize, out int pBmpSize);
		...
		/// <returns>TRUE:   获取成功  FALSE:  获取失败</returns>
		[DllImport("HikPlayM4.dll")]
        public static extern bool Hik_PlayM4_GetJPEG(int nPort, byte[] pJpeg, int nBufSize, out int pJpegSize);
