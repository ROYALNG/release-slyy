...
{
    /// <summary>
    /// Encapsulates control that visualy displays certain integer value and allows user to change it within desired range. It imitates
    /// <see cref="System.Windows.Forms.TrackBar"/> as far as mouse usage is concerned.
    /// <remarks>
    /// Author:Michal Brylka
    /// URL:http://www.codeproject.com/KB/selection/ColorSlider.aspx
    /// </remarks>
    /// </summary>
    [ToolboxBitmap(typeof(ColorSlider), "NHikPlayer.Controls.ColorSlider.bmp")]
        ...
        private Color[,] aColorSchema = new Color[,]
            {
                ...
                {
                    Color.White, Color.Gainsboro, Color.Silver, Color.FromArgb(193, 193, 193), Color.FromArgb(229, 229,229),
                    Color.FromArgb(243, 243, 243), Color.FromArgb(52, 101, 164), Color.FromArgb(174, 200, 228)
                }
            };
