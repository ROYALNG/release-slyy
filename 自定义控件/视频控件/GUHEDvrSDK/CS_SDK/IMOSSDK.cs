...
*/
    ...
    public class IMOSSDK
    {
        ...
        public const string SDK_IMOS = @".\Driver\IMOS\imos_sdk.dll";
        public const string SDK_XP_FRAME = @".\Driver\IMOS\xp_frame.dll";
        ...
        [DllImport(SDK_IMOS, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(SDK_IMOS, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32 IMOS_AutoKeepAlive(ref USER_LOGIN_ID_INFO_S pstUserLoginIDInfo);
        [DllImport(SDK_XP_FRAME, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns></returns>
        [DllImport(SDK_IMOS, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32 IMOS_RegCallBackPrcFuncEx(ref USER_LOGIN_ID_INFO_S stUserLoginIDInfo, IntPtr pfnCallBackProcEx);
        ...
        /// <param name="ptrParam">返回的数据指针</param>
        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public delegate void CALL_BACK_PROC_EX_PF(ref USER_LOGIN_ID_INFO_S pstUserLoginIDInfo, UInt32 ulProcType, IntPtr ptrParam);
