...
namespace GHIBMS.DvrSDK
{
    ...
    {
        public const string SDK_PATH = @".\Driver\hikvision\HCNetSDK.dll";
        ...
        public static bool NET_DVR_Init2()
        {
            if (!bInit)
            {
                if (NET_DVR_Init())
        ...
        **************************************************/
        ...
        public const int NET_DVR_GET_RECORD_CHANNEL_INFO = 6013;  //获取：录像通道信息
        public const int NET_DVR_SET_RECORD_CHANNEL_INFO = 6014;  //设置：录像通道信息
        ...
        **********************************************************/
        ...
        [DllImport(SDK_PATH)]
        public static extern bool NET_DVR_MatrixGetDeviceStatus(int lUserID, out NET_DVR_DECODER_WORK_STATUS lpDecoderCfg);
        ...
        [DllImport(SDK_PATH)]
        public static extern bool NET_DVR_GetDVRWorkState_V30(int lUserID, out NET_DVR_WORKSTATE_V30 pWorkState);
