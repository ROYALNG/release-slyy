...
namespace GHIBMS.DvrSDK
{
    ...
    public struct NET_DVR_DEVICEINFO_V30
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK.SERIALNO_LEN, ArraySubType = UnmanagedType.I1)]
    ...
    public sealed class HCNetSDK
    {
        ...
        public static bool NET_DVR_Cleanup2()
        {
            if (bInit)
            {
                if (NET_DVR_Cleanup())
        ...
        **************************************************/
        ...
        /// 被动解码异常
        /// </summary>
        public const int EXCEPTION_PASSIVEDECODE = 0x8012;
        /// <summary>
        /// 邮件测试异常
        /// </summary>
        public const int EXCEPTION_EMAILTEST = 0x8013;
        /// <summary>
        /// 备份异常
        /// </summary>
        public const int EXCEPTION_BACKUP = 0x8014;
        /// <summary>
        /// 预览时重连成功
        /// </summary>
        public const int PREVIEW_RECONNECTSUCCESS = 0x8015;
        /// <summary>
        /// 报警时重连成功
        /// </summary>
        public const int ALARM_RECONNECTSUCCESS = 0x8016;
        ...
        /// <returns></returns>
        [DllImport("HCNetSDK.dll")]
        public static extern bool NET_DVR_Logout_V30(long lUserID);
        /// <summary>
        /// 注销用户
        ...
        /// <summary>
        /// 6.1.31   保存捕获到的数据到指定的文件(*.mp4)中
        ///     可用本函数实现客户端录像功能
        ///     NET_DVR_API BOOL __stdcall NET_DVR_SaveRealData_V30(
        ///                  LONG    lRealHandle,
        ///                  DWORD   dwTransType,
        ///                  char    *sFileName
        ///                );
        ...
        /// </returns>
        [DllImport("HCNetSDK.dll")]
        public static extern int NET_DVR_FindNextFile_V30(int lFindHandle, out NET_DVR_FINDDATA_V30 lpFindData);
        /// <summary>
        /// 文件信息获取
        ...
        //[DllImport("HCNetSDK.dll")]
        //public static extern bool NET_DVR_PlayBackControl_V4(int lPlayHandle, uint dwControlCode, uint dwInValue, out uint LPOutValue);
        /// <summary>
        /// 7.3.11 刷新显示
        ///     说明
        ...
        /// 上传报警信息(8000报警信息主动上传)
        /// </summary>
        public const int COMM_ALARM                     = 0x1100;    // 上传报警信息
        //对应NET_DVR_PLATE_RESULT
        public const int   COMM_ALARM_PLATE				=0x1101;	//车牌识别报警信息
        //对应NET_VCA_RULE_ALARM
        public const int   COMM_ALARM_RULE				=0x1102;	//行为分析报警信息
        public const int  COMM_ALARM_PDC                =0x1103;    // 人数统计报警信息
        public const int   COMM_ALARM_VIDEOPLATFORM     =0x1104;    // 视频综合平台报警
        public const int  COMM_ALARM_ALARMHOST          =0x1105;  // 网络报警主机报警
        public const int   COMM_ALARM_FACE              =0x1106;   // 人脸检测识别报警信息
        ...
        /// <summary>
        /// 混合型DVR在IPC接入配置改变时的报警信息上传
        /// </summary>
        public const int COMM_IPCCFG = 0x4001;
        /// <summary>
        /// 混合型DVR在IPC接入配置改变时的报警信息上传（扩展）
        /// </summary>
        ...
        public const int NET_DVR_GET_ALARMHOST_MAIN_STATUS=1190;
        ...
        public struct NET_DVR_ALARMER
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = HCNetSDK.NAME_LEN)]
        ...
        public struct NET_DVR_LOG_V30
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = HCNetSDK.LOG_INFO_LEN)]
            public string sInfo;
        }
        /// <summary>
        /// 日志信息
        ...
        public struct NET_DVR_MATRIX_DECINFO
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = HCNetSDK.PASSWD_LEN)]
        ...
        /// <returns></returns>
        [DllImportAttribute("HCNetSDK.dll", EntryPoint = "NET_DVR_SetDVRConfig", CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAsAttribute(UnmanagedType.Bool)]
        ...
        public struct NET_DVR_PPPCFG_V30
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = HCNetSDK.PHONENUMBER_LEN)]
        ...
        public struct NET_DVR_SHOWSTRINGINFO
        {
            ...
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 44)]
             public string sString;
            //[MarshalAs(UnmanagedType.LPArray, SizeConst = 44, ArraySubType = UnmanagedType.I8)] 
            //public String sString;
        ...
        public struct NET_DVR_DDNSPARA_V30
        {
            ...
            */
            public struct DDNS
            {
                ...
                /// </summary>
                [MarshalAs(UnmanagedType.ByValTStr, SizeConst = HCNetSDK.MAX_DOMAIN_NAME)]
        ...
        public struct NET_DVR_EMAILCFG_V30
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = HCNetSDK.MAX_EMAIL_PWD_LEN)]
            public string sPassword;
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = HCNetSDK.MAX_EMAIL_ADDR_LEN)]
        ...
        public struct NET_DVR_NETCFG_OTHER
        {
            ...
            ///     char	sFirstDNSIP[16];
            /// </summary>
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 3216)]
        ...
        //[in] lUserID
        //[in] dwSubSystemNum
        //用户 ID 号， NET_DVR_Login_V30 NET_DVR_Login_V30 NET_DVR_Login_V30 返回值
        //子系统号， oxffffffff表示全部子系统 
        [DllImport("HCNetSDK.dll")]
        public static extern bool NET_DVR_AlarmHostSubSystemSetupAlarmChan(int lUserID, uint dwSubSystemNum);
        //对防区 子系统撤防 
        [DllImport("HCNetSDK.dll")]
        public static extern bool NET_DVR_AlarmHostSubSystemCloseAlarmChan(int lUserID, uint dwSubSystemNum);
        //对防区 子系统进行消警 子系统进行消警 
        [DllImport("HCNetSDK.dll")]
        public static extern bool NET_DVR_AlarmHostClearAlarm(int lUserID, uint dwSubSystemNum);
        //对防区旁路
        [DllImport("HCNetSDK.dll")]
        public static extern bool NET_DVR_BypassAlarmChan(int lUserID,ref NET_DVR_ALARMIN_SETUP lpInter);
        //对防区撤销旁路
        [DllImport("HCNetSDK.dll")]
        public static extern bool NET_DVR_UnBypassAlarmChan(int lUserID, ref NET_DVR_ALARMIN_SETUP lpInter);
          ...
          public struct NET_DVR_SWITCH_ALARM
        {
              ...
              /// <summary>
              ///  报警类型 0--正常，1--短路，2--断路,3-异常 
              /// </summary>
              public byte byAlarmType;
               /// <summary>
            /// 保留
            ///     public byte byRes[41];
            /// </summary>
