...
namespace DvrSDK
{
    public class VlcPlayer : IDisposable
    {
        ...
        #region player
        private static IntPtr libvlc_instance_ = IntPtr.Zero;
        private IntPtr libvlc_media_player_ = IntPtr.Zero;
        ...
        public bool PlayUrl(string url)
        {
            ...
            if (libvlc_media != IntPtr.Zero)
            {
                ...
                LibVlcAPI.libvlc_media_player_play(libvlc_media_player_);
                LibVlcAPI.libvlc_video_set_mouse_input(libvlc_media_player_, 0);
                LibVlcAPI.libvlc_video_set_key_input(libvlc_media_player_, 0);
        ...
        {
            LibVlcAPI.libvlc_video_take_snapshot(libvlc_media_player_, stream, Encoding.UTF8.GetBytes(path), 0, 0);
        }
    ...
    {
        public const string LIBVLC_PATH = @".\Driver\Vlc\libvlc.dll";
        ...
        [DllImport(LIBVLC_PATH, CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
        ...
        [DllImport(LIBVLC_PATH, CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(LIBVLC_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern void libvlc_video_set_mouse_input(IntPtr p_mi, ushort on);

        [DllImport(LIBVLC_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern void libvlc_video_set_key_input(IntPtr p_mi, ushort on);

        [DllImport(LIBVLC_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern void libvlc_video_set_aspect_ratio(IntPtr libvlc_media_player, string aspectRatio);
